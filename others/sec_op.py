...
def main():
    ...
    init_gains = torch.tensor([0.3281109929084778, 0.2776108682155609, 0.34645262360572815, 2.2867772579193115,
                    9.298027992248535, 9.047860145568848, 6.459726810455322, 10.848176956176758,
                    0.2843894064426422, 0.2643522322177887, 5.391777038574219, 1.9903579950332642], dtype=torch.float32, device=device)
